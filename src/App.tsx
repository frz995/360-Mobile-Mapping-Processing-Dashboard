...
export default function App() {
  ...
  const TRANSLATIONS: Record<string, Record<string, string>> = {
    ...
    zh: {
      ...
      workspaceCategoryCore: '仪表板',
      workspaceCategoryProduction: '生产',
    ...
    ja: {
      ...
      workspaceCategoryCore: 'ダッシュボード',
      workspaceCategoryProduction: '生産',
